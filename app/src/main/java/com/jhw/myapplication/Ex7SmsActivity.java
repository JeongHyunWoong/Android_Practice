...
public class Ex7SmsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main10_sms_gwen);

        txtPhoneNo = (EditText) findViewById(R.id.editPhone);
        txtMessage = (EditText) findViewById(R.id.editMsg);
        btnSendSMS = (Button) findViewById(R.id.btn1);
