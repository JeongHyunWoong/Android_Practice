...
public class Ex15SharedPreferencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main18_shared_apalios);
    ...
    Button.OnClickListener mClick = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            {
                case R.id.btn1:
                    Toast.makeText(getApplication(), "로그인이 완료되었습니다!", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
