...
public class Ex21SQLiteExJoin extends AppCompatActivity {

    //SQLITE 데이타베이스 관련변수
    SQLiteDatabase db;
    Ex21MySQLiteOpenHelper helper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main24_sqlite_join_pyke);

        //데이베이스 생성.
        helper = new Ex21MySQLiteOpenHelper(
                Ex21SQLiteExJoin.this, // 현재 화면의 context
                "member2.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnJoin:
                    ...
                    {
                        Toast.makeText(Ex21SQLiteExJoin.this, "아이디를 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    {
                        Toast.makeText(Ex21SQLiteExJoin.this, "비번을 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    //공백없이 입력잘되었을경우 변수에 저장
                    ...
                    {
                        Toast.makeText(Ex21SQLiteExJoin.this, "이름을 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    //공백없이 입력잘되었을경우 변수에 저장
                    ...
                    {
                        Toast.makeText(Ex21SQLiteExJoin.this, "연락처를 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    {
                        Toast.makeText(Ex21SQLiteExJoin.this, "주소를 입력하세요.",  Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    //회원가입 후 저장정보 확1인하기.
                    Intent intentJoinOk = new Intent(Ex21SQLiteExJoin.this, Ex21JoinOkActivity.class);
